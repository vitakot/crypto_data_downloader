...
#ifndef INCLUDE_STONKY_HYPERLIQUID_DOWNLOADER_H
#define INCLUDE_STONKY_HYPERLIQUID_DOWNLOADER_H
...
namespace stonky {
class HyperliquidDownloader final : public IExchangeDownloader {
    struct P;
    std::unique_ptr<P> m_p{};

public:
    explicit HyperliquidDownloader(std::uint32_t maxJobs, bool deleteDelistedData = false);

    ~HyperliquidDownloader() override;
...
#endif //INCLUDE_STONKY_HYPERLIQUID_DOWNLOADER_H
